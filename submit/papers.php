...
<div class="container main">
	<div class="row">
		...
		<article class="ten columns" role="main">
			...
			<ul>
				<li><strong>Friday May 22, 2015</strong>: Submissions DUE, 16:59 PDT (23:59 UTC)</li>
				<li><strong>Friday July 3, 2015</strong>: Review Round 1 Results Announced </li>
				<li><strong>Wednesday July 29, 2015</strong>: Revised Submissions DUE, 16:59 PDT
					(23:59 UTC)</li>
					<li><strong>Monday August 24, 2015</strong>: Final Paper Announcements</li>
					<li><strong>Tuesday October 13th, 2015</strong>: Camera Ready Copy DUE,  16:59 PDT
						(23:59 UTC)</li>
					</ul>

					<h2>Call for Papers</h2>
					<p>
						The <?php echo $year; ?> ACM Conference on Computer-Supported Cooperative Work and
					...
					<p>We invite authors to submit papers that inform the design or deployment of
						collaborative or social systems; introduce novel systems, interaction techniques,
						or algorithms; or study existing collaborative or social practices. The scope of
						CSCW includes social computing and social media, crowdsourcing, open
						collaboration, technologically-enabled or enhanced communication, CSCL,
						MOOCs, and related educational technologies, multi-user input technologies,
						collaboration, awareness, information sharing, and coordination. This scope
						spans socio-technical domains of work, home, education, healthcare, the arts,
						socializing, and entertainment. The technical program seeks novel research
						results or new ways of thinking about, studying, or supporting shared
						activities. We welcome contributions across a variety of research techniques,
						approaches, and domains, including:
						<ul>
							<li><strong>Social and crowd computing.</strong> Studies, theories, designs,
								mechanisms, systems, and/or infrastructures addressing social
								media, social networking, wikis, blogs, online gaming, crowdsourcing,
								...
								<li><strong>Theories and models.</strong>   Critical analysis or organizing theory (e.g. sociological theories, group coordination, etc.) with clear relevance to
									the design or study of social and collaborative systems. </li>
									<li><strong>Empirical investigations.</strong>   Findings, guidelines, and/or studies
										relating to technologies, practices, or use of communication,
										collaboration, and social technologies. </li>
										<li><strong>Social and collaborative practices.</strong> Characterizing the nature of collaboration and social interaction through studies of practice, including both work practice and non-work collaborative and social practices. </li>
										<li><strong>Mining and Modeling.</strong>  Studies, analyses, algorithms, and infrastructures for making use of large and small scale data.</li>
										...
										<li><strong>CSCW and social computing for underserved populations.</strong>   Studies, systems, design, and other research focused on social and collaborative computing for the elderly, disabled, impoverished, or otherwise underserved user communities. </li>
									...
									<p>Joe Konstan, University of Minnesota <br />
										Pernille Bjørn, IT University in Copenhagen <br />
										<a href="mailto:cscw<?php echo $year; ?>papers@acm.org">cscw<?php echo $year; ?>papers@acm.org</a></p>
									...
									<p>Papers must be submitted via the <a href="https://precisionconference.com/~sigchi/" target="_blank">Precision Conference System (PCS)</a> by 16:59 Pacific Daylight Time (PDT) / 23:59 UTC on May 22nd 2015. The site will open for submissions beginning  Monday April 20th. Papers in the "Revise & Resubmit" category must be re-submitted via the PCS system by 16:59 PDT on July 29th 2015</p>

									<p>Authors submitting papers for peer-review to ACM publications make the following representations (see <a href="http://www.acm.org/publications/policies/author_representations" target="_blank">http://www.acm.org/publications/policies/author_representations</a> for full policy statement):</p>
									<ul>
									<li>That the paper submitted is original, that the listed authors are the creators of the work, that each author is aware of the submission and that they are listed as an author, and that the paper is an honest representation of the underlying work. 
									</li>
									<li>
									...
									<li>That they have the rights and intent to publish the work in the venue to which it is submitted, if the work is accepted. For conference papers, this includes the expected ability and intent to have an author of the paper register for and attend the conference to present the paper, if required. 
									</li>
									<li>
									That any prior publications on which this work is based are documented appropriately in the paper and/or in a cover letter available to reviewers. This documentation includes providing an explanation of the incremental contribution of submitted CSCW paper that extends prior results published elsewhere. (In cases of doubleblind review, this information should be supplied to the editor or program chair only.) 
									</li>
									</ul>
									<p>
									...
									<p>Papers will undergo two review cycles. After the first round of review, a submission will receive either a "Revise & Resubmit" or a "Reject" notification (along with the reviews themselves). Submissions rejected in the first round cannot be revised for CSCW <?php echo $year; ?>, but authors can begin reworking them for submission to other venues. Authors of papers designated "Revise & Resubmit" will have two weeks to revise their paper in response to the reviewers' comments. Authors will need to allocate time for possible revisions during the period between  July 3rd and July 29, 2015. Revised papers must be re-submitted via the PCS system by 16:59 PDT on July 29, 2015. <strong>Note that an invitation to "Revise & Resubmit" is not a guarantee of acceptance--the revision will be re-reviewed as the basis for the final decision.</strong> This is similar to a journal process, except that it is limited to a single revision with a strict deadline.</p>
									...
									<p>
									With the resubmission of R&R papers, authors are asked to provide a letter explaining how they approached the comments by the reviewers and incorporated the changes in the revision. See <a href="http://research.microsoft.com/en-us/um/people/merrie/temp/change_log_samples.html" target="_blank"> examples of "change summary" documents</a> submitted with papers in past CSCWs
									</p>
									<p>This is not an invitation to submit extended abstracts or incomplete papers; please submit only work of publishable quality. <strong>Incomplete or otherwise inappropriate submissions will be desk-rejected without review.</strong> Based on prior years’ experience with this process, we anticipate that roughly half of submissions will be rejected after the first round of this process. Note that the dual-round review process is not inherently tied to any target acceptance rates.</p>
									...
									<ul>
										<li>Technical, e.g. building novel systems, algorithms, implementing novel features in existing systems, etc. 
										</li>
										<li>Empirical-Qualitative, e.g. ethnography, workplace studies, qualitative user studies, etc. 
										</li>
										<li>Empirical-Quantitative, e.g. "big data," quantitative user studies, statistical methods, etc. 
										</li>
										<li>Design, e.g. design implications, guidelines, methods, techniques, etc
										</li>
										<li>Mixed Methods, e.g., combined qualitative and quantitative empirical research, design explorations combined with technical feature development.
										</li>
										<li>Theoretical, e.g. conceptual frameworks, theory underpinning CSCW studies/domains, theoretical analysis.
										</li>
									</ul>
									<p>This information will be used to match the paper with a program committee member who is experienced with work of that character. CSCW values work from a variety of interdisciplinary and methodological perspectives - specific evaluation types are not a prerequisite for acceptance (Greenberg & Buxton, 2008).
									</p>
									
									<p>Greenberg, S., and Buxton, B. "Usability evaluation considered harmful (Some of the time)" in: CHI, ACM, Florence, Italy, 2008, pp. 111-120.</p>
									...
									<h2><a class='anchortag' name='lastingimpact' style='text-decoration:none;'>"CSCW Lasting Impact" Award</a></h2>

									<p>
									The CSCW Lasting Impact award will recognize a paper published at the CSCW conference at least 10 years ago (CSCW 2005 or earlier) that has been extremely influential since its publication. The Lasting Impact Award winner will be determined by a committee consisting of past CSCW Papers Chairs, and chaired by this year's Papers Chairs. If you would like to nominate a paper for consideration, please email the papers chairs by Monday October 19, 2015, including the paper's title, author list, and year of publication, as well as a brief paragraph explaining why the paper deserves recognition for "lasting impact"
									</p>

									<h2>Accepted Papers</h2>

									<p>Authors will be expected to prepare a camera-ready version of their paper in accordance with ACM’s Digital Library formatting guidelines. Authors may be asked to identify funding sources (to assist in compliance with government access mandates). Further information will be provided at the time of acceptance. </p>

									<p>
									The CSCW Proceedings is a peer-reviewed archival publication. <strong>AUTHORS TAKE NOTE: The official publication date is the date the proceedings are made available in the ACM Digital Library. This date is two weeks prior to the first day of the conference (February 13, 2016).</strong> The official publication date affects the deadline for any patent filings related to published work.
									</p>
									<p>
