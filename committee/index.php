	...
	<div class="container main">
		<div class="row">
			<article class="ten columns" role="main">
				<h1>CSCW 2016 Committee</h1>
				
				<h2 class="h3">General Co-Chairs</h2>
				<p>Andrea Forte, Drexel University<br />
				Dan Cosley, Cornell University<br />
				<a class="email" href="mailto:chairs2016@cscw.acm.org">chairs2016@cscw.acm.org</a>
				</p>
				...
				<a class="email" href="mailto:publicity2016@cscw.acm.org">publicity2016@cscw.acm.org</a>
				</p>
				...
				<a class="email" href="mailto:dc2016@cscw.acm.org">dc2016@cscw.acm.org</a>
				</p>
				...
				<a class="email" href="mailto:sv2016@cscw.acm.org">sv2016@cscw.acm.org</a>
				</p>
				
				<h2 class="h3">Treasurer</h2>
				<p>Jeremy Birnholtz, Northwestern University<br />
				<a class="email" href="mailto:treasurer2016@cscw.acm.org">treasurer2016@cscw.acm.org</a>
				</p>
				
				<h2 class="h3">Proceedings Co-Chairs</h2>
				<p>Jacqueline Pike, Duquesne University<br />
				Andrea Wiggins, DataONE<br />
				<a class="email" href="mailto:proceedings2016@cscw.acm.org">proceedings2016@cscw.acm.org</a>
				</p>
				...
				<a class="email" href="mailto:local2016@cscw.acm.org">local2016@cscw.acm.org</a>
				</p>
				
				<h2 class="h3">Sponsorship Co-Chairs</h2>
				<p>Sean Goggins, University of Missouri<br />
				Steve Poltrock<br />
				<a class="email" href="mailto:sponsorship2016@cscw.acm.org">sponsorship2016@cscw.acm.org</a>
				</p>
