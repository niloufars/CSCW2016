	...
	<div class="container main">
		<div class="row">
			<article class="ten columns" role="main">
				<h1>Attending CSCW 2016</h1>
				<p><img src="../images/BCPlacewebcamofFalseCreek.jpg" alt="False Creek" class="img-right" />CSCW 2016 will take place at the Westin Bayshore hotel in beautiful and vibrant Vancouver, BC, Canada. <br />
		        ...
		        <a class="email" href="mailto:local2016@cscw.acm.org">local2016@cscw.acm.org</a></p>
			</article>
