	...
	<div class="container main">
		<div class="row">
			<article class="ten columns" role="main">
				<h1>Welcome to CSCW 2015!</h1>				
				<p>The 18th ACM Conference on Computer-Supported Cooperative Work and Social Computing (CSCW 2015) will be held March 14-18, 2015 in <a href="http://vancouver.ca/default.aspx" target="_blank">Vancouver, Canada.</a></p>
				...
				<p>CSCW 2015 will offer multiple venues for contribution, including Papers, Workshops, Panels, Interactive Posters, Videos, Demonstrations, and a Doctoral Colloquium. Please see the <a href="submit/index.php">Call for Participation</a> for deadlines and additional information.
				</p>
				<p> We invite you to begin planning not only your <a href="submit/index.php">submissions</a>, but also your <a href="attend/index.php">attendance</a> and <a href="volunteer/index.php">involvement</a> at the 2015 conference and to <a href="http://www.sigchi.org/communities/cscw" target="_blank">join</a> the CSCW Community!
				</p>
				<p>The <a href="http://learningatscale.acm.org/las2015/" target="_blank">ACM Conference on Learning at Scale</a> (L@S) will be held March 14-15 and co-located with CSCW 2015.</p>
				<h2>Conference Co-chairs</h2>
					<p>Dan Cosley, Cornell University<br />
					Andrea Forte, Drexel University<br />
					<a href="mailto:chairs2015@cscw.acm.org">chairs2015@cscw.acm.org</a>
					</p>
				<h2>Conference Sponsors</h2>
				<p>If you work for a company or other institution with a strong interest in CSCW, please consider encouraging your employer to become a sponsor. The conference will gratefully acknowledge your employer’s contribution, and it will help prevent increases in registration fees.
				</p>
				<h2>2015 Sponsors</h2>
				<ul class="sponsors-list none">
					...
					<li><a href="http://www.communication.northwestern.edu/" target="_blank"><img src="images/soc.gif" alt="Northwestern School of Communication" /></a></li>
					<li><a href="http://www.research.ibm.com/" target="_blank"><img src="images/IBM-Research-Logo.gif" alt="IBM Research" /></a></li>
					<li><h3>Friends</h3></li>
					<li><a href="http://www.research.google.com/" target="_blank"><img src="images/google_logo_home.png" alt="Google" /></a></li>
				</ul>							
			</article>
			<aside class="five columns offset-by-one">
				...
				<div class="item">
					...
					<div class="inner" id="connect">
						...
						<!--<p>The buzz on <a href="https://twitter.com/hashtag/cscw2015" target="_blank">Twitter</a>:-->
						<a class="twitter-timeline" href="https://twitter.com/search?q=%23cscw2015" data-widget-id="419285811587055616">Tweets about "#cscw2015"</a>
						...
						<div class="fb-like-box" data-href="http://www.facebook.com/acmCSCW" data-colorscheme="light" data-show-faces="false" data-header="true" data-stream="true" data-show-border="false"></div>
