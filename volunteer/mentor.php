...
<div class="container main">
	<div class="row">
		...
		<article class="ten columns" role="main">
			...
			<p>
				The final selection of student reviewers and mentor volunteers are
				done, and inclosed is the <a href="CSCW2015participantskeywords.pdf"
					target="_blank">complete list</a> of all student reviewers and
				their mentors. Please use this list when assigning reviewers.
				Basically the intended way of using the list is as follows. As PC
				member you are looking for reviewers to a particular paper, you open
				the list of available reviewers in the PCS system and see how some
				of possible reviewers fitting the criteria of the paper are not
				someone you know. Therefore you look at the student reviewer list
				and properly you will find the name here, and thus you know that the
				student will be committed to do a great work, as well as getting
			...
			<p>
				<a href="InstructionsCSCWStudentMentorProgram.pdf" target="_blank">This
					document</a> contains tricks of the trade in making CSCW reviews,
				...
				CSCW reviewers to the field but can also be used by others.
			</p>
			<p>
				Other helpful resources are Dan Cosley's blog post <a
					href="http://blogs.cornell.edu/danco/2014/06/12/how-i-review-papers/"
					target="_blank">"How I review papers"</a> and Dave Randall's
				reflections on <a href="DaveRandallReviewingforCSCW.pdf"
					target="_blank">reviewing for CSCW</a>.
			</p>
			...
			<h3>
				How do I sign up to be a review mentor? <br />(Deadline June 1,
				2014)
			</h3>
			<p>
			...
			<ul>
				<li>Name, affiliation, email, how many students you volunteer to
					mentor and up to 5 areas of expertise to help match you with a
					student.</li>
			</ul>
